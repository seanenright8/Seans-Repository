...
const claimPayloadSchema = z.object({
  ...
  total_tariff_amount: z.union([z.literal(''), z.coerce.number().positive()]).optional().transform((v) => (v === '' ? undefined : v)),
  ...
  entries_count: z.union([z.literal(''), z.coerce.number().int().positive()]).optional().transform((v) => (v === '' ? undefined : v)),
